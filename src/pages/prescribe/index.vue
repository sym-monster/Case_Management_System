    ...
    <div class="content" style="width: 1200px">
        <el-form :model="form" label-width="auto" style="max-width: 1200px;">
            ...
            <el-form-item label="就诊时间">
                <el-date-picker v-model="form.time" type="date" placeholder="请选择就诊时间" :disabled-date="disabledDate" />
            </el-form-item>


            <el-form-item label="家庭住址">
                <el-select v-model="form.region" placeholder="请选择家庭住址" style="height: 60px">
            ...
            <el-form-item label="诊断">
                <el-input v-model="form.diagnose" type="textarea" :autosize="{ minRows: 1, maxRows: 10 }"style="font-size: 30px; min-height: 60px;   "/>
            </el-form-item>
            <el-form-item label="处方">
                <el-input v-model="form.desc"  type="textarea" :autosize="{ minRows: 1, maxRows: 10 }"style="font-size: 30px; min-height: 60px;  "/>
            </el-form-item>
            <el-form-item>
...
::v-deep .el-input,
.el-radio.el-radio--large,  .el-select__wrapper{
    height: 60px;
}

::v-deep .el-input__wrapper ,  .el-select__wrapper{
    padding: 0 10px;
}
